...
Confluence.Templates.User.logo = function(opt_data, opt_sb) {
  ...
  if (opt_data.profilePictureInfo['default'] && opt_data.username == opt_data.currentUsername) {
    output.append('<a ', (opt_data.canView) ? ' class="userLogoLink" data-username="' + soy.$$escapeHtml(opt_data.username) + '"' : '', ' href="', soy.$$escapeHtml(""), '/users/editmyprofilepicture.action" title="', soy.$$escapeHtml("Ein Bild von Ihnen selbst hinzuf\xfcgen"), '"><img class="userLogo logo defaultLogo" src="', soy.$$escapeHtml("/s/de_DE-1988229788/4109/76e0dbb30bc8580e459c201f3535d84f9283a9ac.7/_"), '/images/icons/profilepics/add_profile_pic.png" alt="', soy.$$escapeHtml("Benutzersymbol"), ': ', soy.$$escapeHtml("Ein Bild von Ihnen selbst hinzuf\xfcgen"), '"></a>');
  } else {
    if (opt_data.profilePictureInfo.anonymous) {
      output.append('<img class="userLogo logo anonymous" src="', soy.$$escapeHtml("/s/de_DE-1988229788/4109/76e0dbb30bc8580e459c201f3535d84f9283a9ac.7/_"), '/images/icons/profilepics/anonymous.png" alt="', soy.$$escapeHtml("Benutzersymbol"), ': ', soy.$$escapeHtml("Anonym"), '" title="', soy.$$escapeHtml("Anonym"), '">');
      ...
      output.append('"><img class="userLogo logo" src="', soy.$$escapeHtml(""), soy.$$escapeHtml(opt_data.profilePictureInfo.downloadPath), '" alt="', soy.$$escapeHtml("Benutzersymbol"), ': ', soy.$$escapeHtml(opt_data.username), '" title="', soy.$$escapeHtml(opt_data.username), '"></a>');
    } else {
      output.append('<img class="userLogo logo anonymous" src="', soy.$$escapeHtml("/s/de_DE-1988229788/4109/76e0dbb30bc8580e459c201f3535d84f9283a9ac.7/_"), '/images/icons/profilepics/anonymous.png" alt="', soy.$$escapeHtml("Benutzersymbol"), ': ', soy.$$escapeHtml(opt_data.username), '" title="', soy.$$escapeHtml(opt_data.username), '">');
    }
  }
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.User.usernameLink = function(opt_data, opt_sb) {
  ...
  if (opt_data.username && opt_data.username != '') {
    ...
    output.append(soy.$$escapeHtml("Anonym"));
  }
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.User.fullNameOrAnonymous = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append((opt_data.user && opt_data.user.fullName) ? soy.$$escapeHtml(opt_data.user.fullName) : soy.$$escapeHtml("Anonym"));
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.User.usernameOrAnonymous = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append((opt_data.user && opt_data.user.name) ? soy.$$escapeHtml(opt_data.user.name) : soy.$$escapeHtml("Anonym"));
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Comments.displayCommentEditorCommon = function(opt_data, opt_sb) {
  ...
  output.append('<div class="quick-comment-vertical-spacer"></div><div class="quick-comment-body"><div class="quick-comment-loading-container" style="display:', (opt_data.state == 'loading') ? 'block' : 'none', ';"><p class="quick-comment-loading-message">', soy.$$escapeHtml("Editor wird geladen"), '</p></div><div id="editor-messages"></div><div id="all-messages"></div><form style="display:', (opt_data.state == 'loading') ? 'none' : 'block', ';" class="quick-comment-form aui" method="post" ');
...
Confluence.Templates.Comments.userLogo = function(opt_data, opt_sb) {
  ...
  if (opt_data.userInfo.userName == null) {
    ...
    output.append('<a class="userLogoLink" data-username="', soy.$$escapeHtml(opt_data.userInfo.userName), '" href="', soy.$$escapeHtml(""), '/users/editmyprofilepicture.action" title="', soy.$$escapeHtml("Ein Bild von Ihnen selbst hinzuf\xfcgen"), '"><img class="userLogo logo defaultLogo" src="', soy.$$escapeHtml("/s/de_DE-1988229788/4109/76e0dbb30bc8580e459c201f3535d84f9283a9ac.7/_"), '/images/icons/profilepics/add_profile_pic.png" alt="', soy.$$escapeHtml("Benutzersymbol"), ': ', soy.$$escapeHtml("Ein Bild von Ihnen selbst hinzuf\xfcgen"), '"></a>');
  } else {
    ...
    output.append('"><img class="userLogo logo" src="', soy.$$escapeHtml(opt_data.userInfo.profilePicture.path), '" alt="', soy.$$escapeHtml("Benutzersymbol"), ': ', soy.$$escapeHtml(opt_data.userInfo.userName), '" title="', soy.$$escapeHtml(opt_data.userInfo.userName), '"></a>');
  }
  output.append('</p>');
  return opt_sb ? '' : output.toString();
};
...
Confluence.Templates.Comments.commentView = function(opt_data, opt_sb) {
  ...
  Confluence.Templates.Comments.userLogo({userInfo: opt_data.commenter}, output);
  output.append('<div class="comment-header"><h4 class="author">', (opt_data.commenter.userName == null) ? soy.$$escapeHtml("Anonym") : '<a href="' + soy.$$escapeHtml("") + '/display/' + soy.$$escapeUri(opt_data.commenter.userName) + '" class="url fn confluence-userlink" data-username="' + soy.$$escapeHtml(opt_data.commenter.userName) + '">' + soy.$$escapeHtml(opt_data.commenter.displayName) + '</a>', '</h4></div><div class="comment-body"><div class="comment-content wiki-content">', opt_data.comment.html, '</div><div class="comment-actions">');
...
QuickReload.Templates.noticeItem = function(opt_data, opt_sb) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div class="qr-notice-item"><span class="qr-notice-text"></span>&nbsp;&nbsp;<a class="qr-notice-show" href="#">', soy.$$escapeHtml(opt_data.show), '</a>&nbsp;&nbsp;<a class="qr-notice-ignore" href="#">', soy.$$escapeHtml("Ignorieren"), '</a></div>');
  return opt_sb ? '' : output.toString();
};
...
}Confluence.QuickReload.Comments=function(){return{property:"comments",singleText:function(E,D){return AJS.format("Neuer Kommentar von {0}",D(E.commenter))
},manyText:function(D){return AJS.format("{0} neue Kommentare",D.length)
},showText:function(){return "Anzeigen"
...
try {
Confluence.QuickReload=Confluence.QuickReload||{};
AJS.toInit(function(A){Confluence.QuickReload.Page=function(){return{property:"page",singleText:function(C,B){return AJS.format("Neue Bearbeitung von {0}",B(C.editor))
},manyText:function(B){return AJS.format("{0} neue Bearbeitungen",B.length)
},showText:function(){return "Neu laden"
            ...
            function createHandlerFor(type, contentId, contentType) {
                ...
                return function () {
                    ...
                    $likeLink
                        ...
                        .html(type === LIKE ? "Gef\u00E4llt mir nicht mehr" : "Gef\u00E4llt mir");
            ...
            $.ajax({
                ...
                if (AJS.Meta.get("remote-user")) {
                    ...
                    $contentLikeSection.find(".like-button")
                        ...
                        .html(existingLike ? "Gef\u00E4llt mir nicht mehr" : "Gef\u00E4llt mir");
                }
...
(function($) {
    ...
    QuickEdit.QuickComment = {
        ...
        saveCommentErrorHandler: function(message) {
            ...
            var displayMessage = "Der Kommentar konnte nicht gespeichert werden:" + " " + message;

            if (message && message.search(/captcha/i) != -1) {
                displayMessage = "Das eingegebene Wort entspricht nicht dem Text im Bild.";
            } 
