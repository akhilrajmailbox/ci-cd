...
Confluence.Templates.Labels.labels = function(opt_data, opt_sb) {
  ...
  for (var labelIndex44 = 0; labelIndex44 < labelListLen44; labelIndex44++) {
    ...
    output.append('<li class="label-container"><span class="label confluence-label" data-label-id="', soy.$$escapeHtml(labelData44.id), '"><a href="', soy.$$escapeHtml(""), '/label/', soy.$$escapeHtml(opt_data.spaceKey), '/', soy.$$escapeHtml(labelData44.name), '" rel="tag">', (labelData44.prefix == 'global') ? soy.$$escapeHtml(labelData44.name) : soy.$$escapeHtml(labelData44.prefix) + ':' + soy.$$escapeHtml(labelData44.name), '</a> <a href="#" class="remove-label" title="', soy.$$escapeHtml("Delete"), '">&times;</a></span></li>');
  }
  return opt_sb ? '' : output.toString();
};
